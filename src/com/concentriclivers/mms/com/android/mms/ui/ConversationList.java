...
import com.concentriclivers.mms.android.provider.Telephony.Mms;
import com.concentriclivers.mms.android.provider.Telephony.Threads;
...
import com.concentriclivers.mms.com.android.mms.data.Conversation.ConversationQueryHandler;
...
public class ConversationList extends ListActivity implements
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		if (cellBroadcastItem != null) {
			...
			// config.xml.
			boolean isCellBroadcastAppLinkEnabled = this.getResources()
					.getBoolean(R.bool.config_cellBroadcastAppLinks);
			try {
